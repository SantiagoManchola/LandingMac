...
const HomeFooter = () => {
    return(
        <>
            <footer className="font-OP flex xl:flex-row flex-col justify-between xl:w-full xl:max-h-[187px] py-[16px] xl:px-[100px] bg-cafe leading-[9px] text-white text-justify px-2">
                <div className="xl:w-full text-[8px] font-normal">
                ...
                <div className="flex xl:justify-between justify-center gap-[10px] pt-5 ml-[30px]">
