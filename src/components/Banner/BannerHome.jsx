import gorra from "../../assets/bannerItems/gorra.png"
import invitacion from "../../assets/bannerItems/invitacion.svg"

const BannerHome = () => {
    return(
        <>
            <section className="bg-[url('assets/bannerItems/banner_image.jpeg')] bg-[center_top_45%] xl:bg-[75%_77%] xl:h-[962px] bg-no-repeat font-OP">
